...
class MultiProcessSafeRotatingFileHandler(BaseRotatingHandler):
    ...
    def _compute_fn(self):
        ...
        :return:
        """
        return self.baseFilename + "." + time.strftime(self.suffix, time.localtime()) + log_file_extension
...
class MidnightRotatingFileHandler(BaseRotatingHandler):
    ...
    def _open(self):
        filename = '%s.%s%s' % (self.baseFilename, self.date.strftime(self.suffix), log_file_extension)
