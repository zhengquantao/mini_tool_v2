...
def estimate_binned_params(databins, fast_computation, optim_control, opt_method='L-BFGS-B'):
    ...
    if fast_computation:
        optim_result = adam_optimizer(databins, par_init, optim_control['batch_size'], optim_control['learning_rate'],
                                      optim_control['max_iter'],
                                      optim_control['tol'], optim_control['beta1'], optim_control['beta2'],
                                      optim_control['epsilon'], optim_control['logfile'])
